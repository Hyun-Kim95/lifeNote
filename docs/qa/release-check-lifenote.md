...
| Mobile 타입 | `cd apps/mobile && npm run typecheck` | 통과 |

RC·UAT 단계 정의는 [rc-uat-handoff.md](./rc-uat-handoff.md)를 따른다.
...
| Mobile | `apps/mobile/.env` (예시 `apps/mobile/.env.example`) | `EXPO_PUBLIC_API_BASE_URL`, `EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID` 등 |
